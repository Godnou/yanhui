...
C   ---- Arruda-Boyce hyperelastic model
...
C          
      ...
      TERM1=P_Mu/2.D0+INV1*P_Mu/10.D0/P_N
      TERM2=(INV1**TWO)*33.D0/1050.D0*P_Mu/(P_N**TWO)
      TERM3=(INV1**THREE)*19.D0/1750.D0*P_Mu/(P_N**THREE)
      TERM4=(INV1**FOUR)*519.D0/134730.D0*P_Mu/(P_N**FOUR)
      DWab=TERM4+TERM3+TERM2+TERM1
      TERM1=P_Mu/10.D0/P_N
      TERM2=INV1*33.D0/525.D0*P_Mu/(P_N**TWO)
      TERM3=(INV1**TWO)*57.D0/1750.D0*P_Mu/(P_N**THREE)
      TERM4=(INV1**THREE)*1038.D0/67365.D0*P_Mu/(P_N**FOUR)
      DDWab=TERM4+TERM3+TERM2+TERM1
C
      TRBBAR=INV1/THREE
      EG=TWO*DWab/DET
      EK=TWO*P_LAMDA*DET
...
C
      TERM1=1.D0/2.D0+TRACE_BE_TOR/10.D0/P_N_V
      TERM2=(TRACE_BE_TOR**TWO)*33.D0/1050.D0/(P_N_V**TWO)
      TERM3=(TRACE_BE_TOR**THREE)*19.D0/1750.D0/(P_N_V**THREE)
      TERM4=(TRACE_BE_TOR**FOUR)*519.D0/134730.D0/(P_N_V**FOUR)
      DWab_BE_TOR=TERM4+TERM3+TERM2+TERM1
C
      TERM1=1.D0/10.D0/P_N_V
      TERM2=TRACE_BE_TOR*33.D0/525.D0/(P_N_V**TWO)
      TERM3=(TRACE_BE_TOR**TWO)*57.D0/1750.D0/(P_N_V**THREE)
      TERM4=(TRACE_BE_TOR**THREE)*1038.D0/67365.D0/(P_N_V**FOUR)
      DDWab_BE_TOR=TERM4+TERM3+TERM2+TERM1 
C
      DO K1=1,3
